    ...
    return (
            ...
            <div className='h-screen flex items-center justify-center'>
              <div className="m-9 p-9 flex items-center justify-center bg-indigo-800 rounded mt-2 ">
                        ...
                        {message}</p>
                    <button className='ml-4 inline-flex text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg '><Link to={"/"}>x</Link></button>
              </div>
              </div>
            </div>
